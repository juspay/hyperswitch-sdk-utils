let localeStrings: LocaleStringTypes.localeStrings = {
  ...
  surchargeMsgAmount: (currency, str) => <>
    {React.string(`Ett tilläggsbelopp på${CommonUtils.nbsp}`)}
    <strong> {React.string(`${currency} ${str}`)} </strong>
    {React.string({`${CommonUtils.nbsp}kommer att tillämpas för denna transaktion`})}
  </>,
  surchargeMsgAmountForCard: (currency, str) => <>
    {React.string(`Ett tilläggsbelopp på upp till${CommonUtils.nbsp}`)}
    <strong> {React.string(`${currency} ${str}`)} </strong>
    {React.string(`${CommonUtils.nbsp}kommer att tillämpas för denna transaktion`)}
  </>,
