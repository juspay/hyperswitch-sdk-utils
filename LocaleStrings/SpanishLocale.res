let localeStrings: LocaleStringTypes.localeStrings = {
  ...
  surchargeMsgAmount: (currency, str) => <>
    {React.string(`un monto de recargo de${CommonUtils.nbsp}`)}
    <strong> {React.string(`${currency} ${str}`)} </strong>
    {React.string({`${CommonUtils.nbsp}se aplicará para esta transacción`})}
  </>,
  surchargeMsgAmountForCard: (currency, str) => <>
    {React.string(`Un monto de recargo de hasta${CommonUtils.nbsp}`)}
    <strong> {React.string(`${currency} ${str}`)} </strong>
    {React.string(`${CommonUtils.nbsp}se aplicará para esta transacción`)}
  </>,
