let localeStrings: LocaleStringTypes.localeStrings = {
  ...
  surchargeMsgAmount: (currency, str) => <>
    {React.string(`A surcharge amount of${CommonUtils.nbsp}`)}
    <strong> {React.string(`${currency} ${str}`)} </strong>
    {React.string(`${CommonUtils.nbsp}will be applied for this transaction`)}
  </>,
  surchargeMsgAmountForCard: (currency, str) => <>
    {React.string(`A surcharge amount of upto${CommonUtils.nbsp}`)}
    <strong> {React.string(`${currency} ${str}`)} </strong>
    {React.string(`${CommonUtils.nbsp}will be applied for this transaction`)}
  </>,
