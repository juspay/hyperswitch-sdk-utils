let localeStrings: LocaleStringTypes.localeStrings = {
  ...
  surchargeMsgAmount: (currency, str) => <>
    {React.string(`Für diese Transaktion wird ein Zuschlag in Höhe von${CommonUtils.nbsp}`)}
    <strong> {React.string(`${currency} ${str}`)} </strong>
    {React.string(`${CommonUtils.nbsp}erhoben`)}
  </>,
  surchargeMsgAmountForCard: (currency, str) => <>
    {React.string(`Für diese Transaktion wird ein Zuschlagsbetrag von bis zu${CommonUtils.nbsp}`)}
    <strong> {React.string(`${currency} ${str}`)} </strong>
    {React.string(`${CommonUtils.nbsp}erhoben`)}
  </>,
  ...
  deletePaymentMethod: "löschen",
  invalidDigitsCardHolderNameError: "Karteninhaber-Name darf keine Ziffern enthalten",
  invalidDigitsNickNameError: "Der Spitzname darf nicht mehr als 2 Ziffern haben",
  nickNameLengthExceedError: "Der Spitzname darf nicht länger als 12 Zeichen sein.",
