let localeStrings: LocaleStringTypes.localeStrings = {
  ...
  surchargeMsgAmount: (currency, str) => <>
    {React.string(`סכום היטל של${CommonUtils.nbsp}`)}
    <strong> {React.string(`${currency} ${str}`)} </strong>
    {React.string(`${CommonUtils.nbsp}יוחל עבור עסקה זו`)}
  </>,
  surchargeMsgAmountForCard: (currency, str) => <>
    {React.string(`סכום היטל של עד${CommonUtils.nbsp}`)}
    <strong> {React.string(`${currency} ${str}`)} </strong>
    {React.string(`${CommonUtils.nbsp}יחול עבור עסקה זו`)}
  </>,
