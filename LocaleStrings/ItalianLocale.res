let localeStrings: LocaleStringTypes.localeStrings = {
  ...
  surchargeMsgAmount: (currency, str) => <>
    {React.string(`Un importo aggiuntivo di${CommonUtils.nbsp}`)}
    <strong> {React.string(`${currency} ${str}`)} </strong>
    {React.string({`${CommonUtils.nbsp}verrà applicato per questa transazione`})}
  </>,
  surchargeMsgAmountForCard: (currency, str) => <>
    {React.string(`Un importo di supplemento fino a${CommonUtils.nbsp}`)}
    <strong> {React.string(`${currency} ${str}`)} </strong>
    {React.string(`${CommonUtils.nbsp}verrà applicato per questa transazione`)}
  </>,
