...
type localeStrings = {
  ...
  noPaymentMethodsAvailableText: string,
  ...
  bankIssuerPlaceholder: string,
  bankTypeLabel: string,
  bankTypePlaceholder: string,
  blikCodeLabel: string,
  blikCodePlaceholder: string,
  branchCodeLabel: string,
  branchCodePlaceholder: string,
  bsbNumberPlaceholder: string,
  cardNetworkLabel: string,
  cardNetworkPlaceholder: string,
  cardNumberPlaceholder: string,
  cityPlaceholder: string,
  clientUidLabel: string,
  clientUidPlaceholder: string,
  countryPlaceholder: string,
  cryptoNetworkLabel: string,
  cryptoNetworkPlaceholder: string,
  currencyPlaceholder: string,
  cvcPlaceholder: string,
  descriptionLabel: string,
  descriptionPlaceholder: string,
  dialingCodePlaceholder: string,
  ...
  sourceBankAccountIdLabel: string,
...
let defaultLocale = {
  ...
  cardHolderNamePlaceholder: "Card Holder Name (Optional)",
  noPaymentMethodsAvailableText: "No payment methods available.",
  ...
  accountNumberInvalidText: "Enter a valid account number",
  ...
  bankIdentifierPlaceholder: "Bank Identifier",
  bankIssuerPlaceholder: "Select Bank Issuer",
  bankTypeLabel: "Bank Type",
  bankTypePlaceholder: "Select Bank Type",
  blikCodeLabel: "BLIK Code",
  blikCodePlaceholder: "BLIK Code",
  branchCodeLabel: "Branch Code",
  branchCodePlaceholder: "Branch Code",
  bsbNumberPlaceholder: "BSB Number",
  cardNetworkLabel: "Card Network",
  cardNetworkPlaceholder: "Select Card Network",
  cardNumberPlaceholder: "1234 1234 1234 1234",
  cityPlaceholder: "City",
  clientUidLabel: "Client UID",
  clientUidPlaceholder: "Client UID",
  countryPlaceholder: "Select Country",
  cryptoNetworkLabel: "Network",
  cryptoNetworkPlaceholder: "Network",
  currencyPlaceholder: "Select Currency",
  cvcPlaceholder: "123",
  descriptionLabel: "Description",
  descriptionPlaceholder: "Description",
  dialingCodePlaceholder: "Select Dialing Code",
  ...
  expiryMonthPlaceholder: "Select Month",
  expiryYearLabel: "Expiry Year",
  expiryYearPlaceholder: "Select Year",
  firstNamePlaceholder: "First Name",
  giftCardCvcPlaceholder: "CVC",
  giftCardNumberPlaceholder: "Card Number",
  ...
  sortCodePlaceholder: "Sort Code",
  sourceBankAccountIdLabel: "Source Bank Account ID",
