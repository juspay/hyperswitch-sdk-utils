...
type localeStrings = {
  ...
  completeNameEmptyTextPart1: string,
  ...
  cardHeader: string,
  cardBrandConfiguredErrorTextPart1: string,
  cardBrandConfiguredErrorTextPart2: string,
...
let defaultLocale: localeStrings = {
  ...
  completeNameEmptyTextPart1: "Please provide your complete ",
  ...
  cardBrandConfiguredErrorTextPart1: " is not supported at the moment.",
